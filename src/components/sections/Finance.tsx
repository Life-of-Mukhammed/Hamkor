  ...
  return (
    <div className="space-y-8 animate-fade-in text-slate-700 pb-20">
      ...
      <Tabs defaultValue="contracts" className="w-full">
        <div className="border-b border-[#001529]/5 mb-10">
        ...
        <TabsContent value="contracts" className="m-0 space-y-6">
          {contracts.map((contract) => (
            <Card key={contract.id} className="border-none shadow-sm rounded-[32px] bg-[#f4f9ff] overflow-hidden flex relative group hover:shadow-md transition-all">
              ...
              <div className="flex-1 p-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-4">
                    <Badge className="bg-emerald-100/50 text-[#10b981] border-none px-4 py-2 rounded-xl flex items-center gap-2 text-[10px] font-black uppercase">
                ...
                <div className="flex flex-col items-end gap-6">
                  ...
                  <div className="flex items-center gap-4">
                    <Button 
                      ...
                      className="h-12 px-8 rounded-2xl border-[#001529]/10 bg-white text-slate-500 hover:bg-red-50 hover:text-red-600 hover:border-red-100 font-black text-[11px] uppercase tracking-widest transition-all"
                    >
                      Muammo bor (Disput)
                    </Button>
                    <Button 
        ...
        <TabsContent value="status" className="m-0">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="p-10 border-none shadow-sm rounded-[40px] bg-[#f4f9ff] text-center">
              <div className="w-16 h-16 bg-blue-100/50 rounded-[24px] flex items-center justify-center text-[#0b4db1] mx-auto mb-6">
                <ShieldCheck size={32} />
              </div>
            ...
            <Card className="p-10 border-none shadow-sm rounded-[40px] bg-[#f4f9ff] text-center">
              <div className="w-16 h-16 bg-amber-100/50 rounded-[24px] flex items-center justify-center text-amber-600 mx-auto mb-6">
                <Lock size={32} />
              </div>
            ...
            <Card className="p-10 border-none shadow-sm rounded-[40px] bg-[#f4f9ff] text-center">
              <div className="w-16 h-16 bg-emerald-100/50 rounded-[24px] flex items-center justify-center text-emerald-600 mx-auto mb-6">
        ...
        <TabsContent value="methods" className="m-0 animate-fade-in">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="p-12 border-none shadow-sm rounded-[40px] bg-[#f4f9ff] flex items-center gap-8 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="w-20 h-20 bg-white rounded-[28px] flex items-center justify-center text-[#0b4db1] shadow-sm">
                <Landmark size={40} />
              </div>
            ...
            <Card className="p-12 border-none shadow-sm rounded-[40px] bg-[#f4f9ff] flex items-center gap-8 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="w-20 h-20 bg-white rounded-[28px] flex items-center justify-center text-emerald-600 shadow-sm">
                <CreditCard size={40} />
              </div>
              <div className="space-y-1">
        ...
        <TabsContent value="history" className="m-0">
          <Card className="border-none shadow-sm rounded-[40px] bg-[#f4f9ff] p-10">
            <div className="flex justify-between items-center mb-10">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-[#0b4db1] shadow-sm">
                  <History size={24} />
                </div>
              ...
              <div className="flex gap-4">
                <div className="relative w-64">
                  ...
                  <Input placeholder="TRX ID bo'yicha..." className="pl-10 h-11 rounded-xl border-none bg-white text-[11px] font-bold" />
                </div>
                <Button variant="outline" className="h-11 rounded-xl border-[#001529]/5 bg-white text-[11px] font-black uppercase tracking-widest gap-2">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex justify-between items-center p-6 rounded-[24px] bg-white border border-[#001529]/5 hover:shadow-md transition-all group">
                  <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-full bg-[#f4f9ff] flex items-center justify-center text-slate-300 group-hover:text-[#0b4db1] transition-colors">
                      <CreditCard size={18} />
                    </div>
                    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 mt-16">
        ...
        <Card className="lg:col-span-5 border-none shadow-sm rounded-[48px] bg-[#f4f9ff] p-12 flex flex-col">
          <div className="flex justify-between items-center mb-10">
          ...
          <div className="space-y-8">
            <div className="flex justify-between items-start">
              ...
              <Badge className="bg-emerald-100/50 text-emerald-600 border-none font-black text-[11px] px-3 py-1.5 rounded-full">+ 12.4%</Badge>
            </div>
            <div className="space-y-4 pt-4">
              <div className="h-3 w-full bg-white rounded-full overflow-hidden border border-[#001529]/5">
